                        ...
                        <table class="min-w-full bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-lg overflow-hidden">
                            ...
                            <tbody>
                                ...
                                <tr class="hover:bg-gray-50 dark:hover:bg-gray-700">
                                    ...
                                    <td class="px-6 py-4 whitespace-nowrap text-sm border-b border-gray-200 dark:border-gray-700">{{ $item->expected_quantity }} kg</td>
                                    <td class="px-6 py-4 whitespace-nowrap text-sm border-b border-gray-200 dark:border-gray-700">{{ $item->quantity }} kg</td>
