        ...
        <div class="max-w-4xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white dark:bg-gray-800 rounded-lg shadow-md p-6">
                ...
                <form action="{{ route('deliveries.store') }}" method="POST" class="space-y-6">
                    ...
                    @else
                        <div class="mb-4">
                            <label for="bread_id" class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1">Tipo di Pane</label>
                            <select name="bread_id" id="bread_id" class="form-select" required>
                                <option value="">-- Seleziona tipo di pane --</option>
                    ...
                    <div class="mb-4">
                        <label for="point_of_sale_id" class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1">Punto Vendita</label>
                        <select name="point_of_sale_id" id="point_of_sale_id" class="form-select" required>
