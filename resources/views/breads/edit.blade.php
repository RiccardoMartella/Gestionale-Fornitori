                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-6 text">
                                <div>
                                    ...
                                    <input type="text" name="name" id="name" 
                                        class="w-full border border-gray-300 dark:border-gray-600 rounded-md py-2 px-3 focus:ring-2 focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-800 dark:text-white" required value={{$bread->name}}>
                                </div>
                                <div>
                                    ...
                                    <input type="text" name="supplier_id" id="supplier_id" 
                                        class="w-full border border-gray-300 dark:border-gray-600 rounded-md py-2 px-3 focus:ring-2 focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-800 dark:text-white" required value={{$bread->supplier_id}}>
                                </div>
